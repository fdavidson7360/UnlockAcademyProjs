...
from Lesson8.UserProfile import Developer, Designer
...
while create_a_candidate == True:
    try:
        ...
        if candidate == "Developer":
            ...
            user_developer = Developer(dobString, full_name, country, state, number_of_education_years, age,
                                       usr_coding_langs)
