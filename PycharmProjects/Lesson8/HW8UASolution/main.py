...
# from HW8UASolution.Models import Developer, Designer
...
while create_a_candidate == True:
    try:
        ...
        if is_developer:
            user_profile = Developer(dobString, full_name, country, state, number_of_education_years, age,
                                     usr_coding_langs)

        elif is_designer:
            user_profile = Designer(dobString, full_name, country, state, number_of_education_years, age, sw_pkgs)
